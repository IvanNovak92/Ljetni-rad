...
#4
insert into roba(vrsta_robe,datum_berbe,datum_skladistenja,vrsta_boxa,komad_boxa,tezina)
values	('Jabuka Granny','2016.8.9.','2016.10.10','Box Belje','4','1000,5'),
		('Jabuka Jonagold','2016.6.6.','2016.7.7','Box Belje','3','700,5');
...
values	('Belje','11111111111'),
		...
		insert into roba_kooperant(roba,kooperant)
values	(1,1),
		(2,2);
